...
1. Start with [values and data](values-and-data.md): the information a program
   works with.
2. Learn [decisions and repetition](decisions-and-repetition.md): how programs
   choose and repeat actions.
3. Learn [functions and changing state](functions-and-state.md): how to name
   behaviour and make an interactive program respond over time.
4. Put the ideas together in [your first browser game](../create/first-game.md).
